...
st.markdown(
    ...
    <style>
    .stApp {
        background-image: url('image.jpeg'); /* Replace with your image URL or local path */
...
if submitted:
    ...
    input_data = {
        ...
        'amt': amt,
        'Time': trans_time.hour,  # <-- Use only this
        'gender': gender,
        'city': city,
        'state': state,
    ...
    with st.spinner("Predicting..."):
        ...
        if final_input is not None:
            try:
                ...
                result_text = f"⚠️ Fraudulent Transaction ." if prediction[0] == 1 else f"✅ Non-Fraudulent Transaction"
